...
- (void) testDecodingAndDescriptions
{
    ...
    command = [DVDCommand commandWith64Bits:0x000100000000000dL];
    ...
    command = [DVDCommand commandWith64Bits:0x0091000a00040014L];
    ...
    command = [DVDCommand commandWith64Bits:0x0091000a04000004L];
    ...
    command = [DVDCommand commandWith64Bits:0x00a100083000000bL];
    ...
    command = [DVDCommand commandWith64Bits:0x00a1000900050028L];
    ...
    command = [DVDCommand commandWith64Bits:0x00a10009000f0003L];
    ...
    command = [DVDCommand commandWith64Bits:0x00a1000900170003L];
    ...
    command = [DVDCommand commandWith64Bits:0x00a1000900210038L];
    ...
    command = [DVDCommand commandWith64Bits:0x00a100091000000cL];
    ...
    command = [DVDCommand commandWith64Bits:0x00a100093000001dL];
    ...
    command = [DVDCommand commandWith64Bits:0x00a1000960000031L];
    ...
    command = [DVDCommand commandWith64Bits:0x00a10009ce00000aL];
    ...
    command = [DVDCommand commandWith64Bits:0x00a2000900100000L];
    ...
    command = [DVDCommand commandWith64Bits:0x00b1000010000009L];
    ...
    command = [DVDCommand commandWith64Bits:0x00b1000900000003L];
    ...
    command = [DVDCommand commandWith64Bits:0x00b100090004000eL];
    ...
    command = [DVDCommand commandWith64Bits:0x00b10009000f0024L];
    ...
    command = [DVDCommand commandWith64Bits:0x00b1000900190038L];
    ...
    command = [DVDCommand commandWith64Bits:0x00b1000900250050L];
    ...
    command = [DVDCommand commandWith64Bits:0x00d100030002000fL];
    ...
    command = [DVDCommand commandWith64Bits:0x00d1000900280056L];
    ...
    command = [DVDCommand commandWith64Bits:0x2001000000000407L];
    ...
    command = [DVDCommand commandWith64Bits:0x2004000000000005L];
    ...
    command = [DVDCommand commandWith64Bits:0x2004000000000010L];
    ...
    command = [DVDCommand commandWith64Bits:0x2004000000000022L];
    ...
    command = [DVDCommand commandWith64Bits:0x200400000000002dL];
    ...
    command = [DVDCommand commandWith64Bits:0x2006000000000002L];
    ...
    command = [DVDCommand commandWith64Bits:0x2006000000000406L];
    ...
    command = [DVDCommand commandWith64Bits:0x2006000000000420L];
    ...
    command = [DVDCommand commandWith64Bits:0x2006000000001002L];
    ...
    command = [DVDCommand commandWith64Bits:0x200600000000140bL];
    ...
    command = [DVDCommand commandWith64Bits:0x2006000000001801L];
    ...
    command = [DVDCommand commandWith64Bits:0x2006000000002801L];
    ...
    command = [DVDCommand commandWith64Bits:0x20a400000065000cL];
    ...
    command = [DVDCommand commandWith64Bits:0x20a4000100010008L];
    ...
    command = [DVDCommand commandWith64Bits:0x20a4000900120013L];
    ...
    command = [DVDCommand commandWith64Bits:0x20a50009cc010001L];
    ...
    command = [DVDCommand commandWith64Bits:0x20a50009cc0b000bL];
    ...
    command = [DVDCommand commandWith64Bits:0x20a50009cc150015L];
    ...
    command = [DVDCommand commandWith64Bits:0x20a6000000040c04L];
    ...
    command = [DVDCommand commandWith64Bits:0x20a6000300031401L];
    ...
    command = [DVDCommand commandWith64Bits:0x20a6000900010401L];
    ...
    command = [DVDCommand commandWith64Bits:0x20a60009000d1405L];
    ...
    command = [DVDCommand commandWith64Bits:0x20a6000900151401L];
    ...
    command = [DVDCommand commandWith64Bits:0x20a6000900221c01L];
    ...
    command = [DVDCommand commandWith64Bits:0x20a6000908120801L];
    ...
    command = [DVDCommand commandWith64Bits:0x20a600098601043cL];
    ...
    command = [DVDCommand commandWith64Bits:0x20a70009cea90029L];
    ...
    command = [DVDCommand commandWith64Bits:0x20d40003012c0022L];
    ...
    command = [DVDCommand commandWith64Bits:0x3002000000030000L];
    ...
    command = [DVDCommand commandWith64Bits:0x30020000000d0000L];
    ...
    command = [DVDCommand commandWith64Bits:0x3002000000170000L];
    ...
    command = [DVDCommand commandWith64Bits:0x3002000000210000L];
    ...
    command = [DVDCommand commandWith64Bits:0x3006000102830000L];
    ...
    command = [DVDCommand commandWith64Bits:0x3006000200c00000L];
    ...
    command = [DVDCommand commandWith64Bits:0x3008000701c00000L];
    ...
    command = [DVDCommand commandWith64Bits:0x3025000b00010001L];
    ...
    command = [DVDCommand commandWith64Bits:0x3025001500010001L];
    ...
    command = [DVDCommand commandWith64Bits:0x410000008f000000L];
    ...
    command = [DVDCommand commandWith64Bits:0x5600000008000000L];
    ...
    command = [DVDCommand commandWith64Bits:0x6100000000820000L];
    ...
    command = [DVDCommand commandWith64Bits:0x6100000200820000L];
    ...
    command = [DVDCommand commandWith64Bits:0x6100000600870000L];
    ...
    command = [DVDCommand commandWith64Bits:0x61000009000e0000L];
    ...
    command = [DVDCommand commandWith64Bits:0x6100000e00040000L];
    ...
    command = [DVDCommand commandWith64Bits:0x61c00d06000d0040L];
    ...
    command = [DVDCommand commandWith64Bits:0x7100000100030000L];
    ...
    command = [DVDCommand commandWith64Bits:0x71000001000d0000L];
    ...
    command = [DVDCommand commandWith64Bits:0x7100000100170000L];
    ...
    command = [DVDCommand commandWith64Bits:0x7100000500440000L];
    ...
    command = [DVDCommand commandWith64Bits:0x7100000900050000L];
    ...
    command = [DVDCommand commandWith64Bits:0x71000009001f0000L];
    ...
    command = [DVDCommand commandWith64Bits:0x7100000b00050000L];
    ...
    command = [DVDCommand commandWith64Bits:0x7100000d00010000L];
...
- (void) testExecutionOfSimpleInstructions
{
    ...
    [[DVDCommand commandWith64Bits:0x7400000100010000L] executeAgainstVirtualMachine:vm];
    STAssertTrue([vm generalPurposeRegister:1] == 2, @"7400000100010000 | g[1] -= 0x1");

	//  7500000100020000 | g[1] *= 0x2
    [[DVDCommand commandWith64Bits:0x7500000100020000L] executeAgainstVirtualMachine:vm];
    STAssertTrue([vm generalPurposeRegister:1] == 4, @"7500000100010000 | g[1] *= 0x2");

	//  7600000100020000 | g[1] %= 0x2
    [[DVDCommand commandWith64Bits:0x7600000100020000L] executeAgainstVirtualMachine:vm];
	...
	[[DVDCommand commandWith64Bits:0x71000001FFFF0000L] executeAgainstVirtualMachine:vm];
	...
	[[DVDCommand commandWith64Bits:0x7100000100000000L] executeAgainstVirtualMachine:vm];
	...
	[[DVDCommand commandWith64Bits:0x7100000164000000L] executeAgainstVirtualMachine:vm];
	...
	[[DVDCommand commandWith64Bits:0x7500000100640000L] executeAgainstVirtualMachine:vm];
