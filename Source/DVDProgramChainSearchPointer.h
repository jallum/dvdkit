...
@interface DVDProgramChainSearchPointer : NSObject {
    uint8_t entryId;
...
- (id) initWithEntryId:(uint8_t)entry_id parentalMask:(uint16_t)ptl_id_mask programChain:(DVDProgramChain*)programChain;

@property (readonly) uint8_t entryId;
@property (readonly) DVDProgramChain* programChain;
